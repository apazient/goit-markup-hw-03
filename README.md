...
Створи репозиторій goit-markup-hw-03.
    ...
    Виконай розмітку і оформлення макета сторінки домашнього завдання #3 https://www.figma.com/file/1ehrLBauvVFu4mVhxsHzyZ/Web-Studio-(Version-2.1)?t=OytnVZdKlQgALNie-0.
